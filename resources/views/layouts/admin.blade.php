    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-gray-800 text-white">
            ...
            <nav class="mt-4">
                ...
                <a href="{{ route('admin.courses.index') }}" class="block py-2 px-4 hover:bg-gray-700 {{ request()->routeIs('admin.courses.*') ? 'bg-gray-700' : '' }}">
                    Manage Courses
                </a>
                <a href="{{ route('admin.users.index') }}" class="block py-2 px-4 hover:bg-gray-700 {{ request()->routeIs('admin.users.*') ? 'bg-gray-700' : '' }}">
                    Manage Users
                </a>
                <a href="{{ route('admin.payments.index') }}" class="block py-2 px-4 hover:bg-gray-700 {{ request()->routeIs('admin.payments.*') ? 'bg-gray-700' : '' }}">
                    Manage Payments
                </a>
                <a href="{{ route('admin.articles.index') }}" class="block py-2 px-4 hover:bg-gray-700 {{ request()->routeIs('admin.articles.*') ? 'bg-gray-700' : '' }}">
                    Manage Articles
                </a>
            </nav>
        </aside>
