        ...
        <div class="p-6 md:p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="youtube_video_id" id="youtube_video_id" value="{{ old('youtube_video_id', $lesson->youtube_video_id) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="module" id="module" value="{{ old('module', $lesson->module) }}" required
                ...
                <div>
                    ...
                    <input type="number" name="order" id="order" value="{{ old('order', $lesson->order) }}" required
                ...
                <div>
                    ...
                    <input type="number" name="duration" id="duration" value="{{ old('duration', $lesson->duration) }}"
